...
export default function PreQuizWaitingRoom() {
  ...
  const isParticipantForExam = useParticipant(
    (state) => state.isParticipantForExam,
  );
  ...
  const isPhysicallyInStorage = useParticipant((state) =>
    state.isPhysicallyInStorage(),
  );
        ...
        <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white">
          {isEnded ? (
            ...
            <div className="text-center space-y-6 animate-in zoom-in-95 duration-300">
              ...
              <button
                onClick={() => navigate("/")}
                className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all active:scale-95"
              >
                Return to Dashboard
              </button>
            </div>
            ...
            <div className="text-center space-y-6 animate-in slide-in-from-bottom-4 duration-500">
              ...
              <header>
                ...
                <p className="text-slate-400 text-sm font-medium mt-2">
                  Please return 5 minutes before start time.
                </p>
              </header>
              <button
                onClick={fetchQuiz}
                className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all flex items-center gap-2 mx-auto"
              >
            ...
            <div className="w-full animate-in fade-in duration-500">
              <header className="mb-8 text-center md:text-left">
                ...
                <p className="text-slate-400 text-sm font-medium">
                  Verify credentials to initialize proctoring.
                </p>
              </header>
