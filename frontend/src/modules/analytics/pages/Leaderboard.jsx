            ...
            <tbody className="divide-y divide-slate-50">
              {filteredParticipants.map((p) => (
                <tr
                  ...
                  className="hover:bg-[#4a9cb0]/5 transition-colors group"
                >
                  <td className="p-5">
                    {p.rank <= 3 ? (
                      <div
                      ...
                      <span className="ml-3 font-bold text-slate-300">
                        #{p.rank}
                      </span>
                    )}
                  </td>
                  ...
                  <td className="p-5 text-center font-mono text-sm text-slate-500">
                    {Math.floor(p.totalTimeSpent / 60)}m {p.totalTimeSpent % 60}
                    s
                  </td>
                  ...
                  <td className="p-5 text-center">
                    <button
                      onClick={() =>
                        navigate(
                          `/quizAnalytics/${quizId}/participant/${p.participantId}`,
                        )
                      }
